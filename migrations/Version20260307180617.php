 ...
 */
final class Version20260307180617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demographie (id INT AUTO_INCREMENT NOT NULL, densite NUMERIC(15, 2) NOT NULL, habitants INT NOT NULL, variation_population NUMERIC(15, 2) NOT NULL, solde_naturel NUMERIC(15, 2) NOT NULL, solde_migratoire NUMERIC(15, 2) NOT NULL, id_annee_id INT DEFAULT NULL, id_departement_id INT DEFAULT NULL, INDEX IDX_1016B0E74E52965 (id_annee_id), INDEX IDX_1016B0E7F19F5D18 (id_departement_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE economie (id INT AUTO_INCREMENT NOT NULL, taux_chomage NUMERIC(15, 2) NOT NULL, taux_pauvrete NUMERIC(15, 2) NOT NULL, id_annee_id INT DEFAULT NULL, id_departement_id INT DEFAULT NULL, INDEX IDX_327AA9724E52965 (id_annee_id), INDEX IDX_327AA972F19F5D18 (id_departement_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE region (id INT AUTO_INCREMENT NOT NULL, code_region INT NOT NULL, id_admin_id INT DEFAULT NULL, INDEX IDX_F62F17634F06E85 (id_admin_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
