 ...
 */
final class Version20260324193225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE logement (id INT AUTO_INCREMENT NOT NULL, logements_total INT NOT NULL, logements_principaux INT NOT NULL, logements_sociaux NUMERIC(15, 2) NOT NULL, logements_individuels NUMERIC(15, 2) NOT NULL, logements_vacants NUMERIC(15, 2) NOT NULL, loyer_social NUMERIC(15, 2) NOT NULL, part_energivore DOUBLE PRECISION DEFAULT NULL, age_moyen DOUBLE PRECISION DEFAULT NULL, logements_demolis INT DEFAULT NULL, id_annee_id INT DEFAULT NULL, id_departement_id INT DEFAULT NULL, INDEX IDX_F0FD44574E52965 (id_annee_id), INDEX IDX_F0FD4457F19F5D18 (id_departement_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
